...
export default function CardHabitacionesDisponibles({ nombre, imagen, descripcion, capacidad, cantidad_camas, precio_persona, funcion, fechas_reserva}) {
                ...
                <Row>
                    ...
                    <Col sm={8}>
                        <Card.Body className='info-hab'>
                            ...
                            <Card.Text>Cantidad de huespedes: {capacidad}</Card.Text>
                            {fechas_reserva}
